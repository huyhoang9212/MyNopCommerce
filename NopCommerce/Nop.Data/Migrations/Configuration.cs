namespace Nop.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Nop.Data.NopObjectContext>
    {
        ...
        {
            var _blogPostDbSet = context.Set<BlogPost>();
            context.Database.ExecuteSqlCommand("DELETE FROM BlogPost");
            context.Database.ExecuteSqlCommand("DELETE FROM BlogComment");
            ...
            _blogPostDbSet.AddOrUpdate(blogPosts.ToArray());
